...
<form class="container" method="POST">
    ...
    <div class="row">
        <div id="right_form_col" class="col-md-4">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="number_ticket" id="exampleFormControlInput1" placeholder="" value="<?php echo $regist->number_ticket ?>" />
            </div>


            <div class="form-group">
                <label for="exampleFormControlInput1">Giá vé</label>
                <input type="number" class="form-control" name="ticket_price" id="exampleFormControlInput1" placeholder="VND" value="<?php echo $regist->ticket_price ?>" />
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput1">Ngày</label>
                <input type="date" class="form-control" name="date" id="exampleFormControlInput1" placeholder="" required value="<?php echo $regist->date ?>" />
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput1">Thời gian bắt đầu</label>
                <input type="time" class="form-control" name="start_time" id="exampleFormControlInput1" placeholder="" required value="<?php echo $regist->start_time ?>" />
            </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" placeholder="Gửi gắm đôi lời.." name="description" id="exampleFormControlTextarea1" rows="2"><?php echo $regist->description ?></textarea>
    </div>
